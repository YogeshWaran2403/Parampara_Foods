import { ShoppingCart, Heart, User, Search, Menu, Home, Info, Phone, Package, LayoutDashboard } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-lg header-sharp-top">
        ...
        <div className="flex items-center justify-between h-16 lg:hidden">
          ...
          >
            ...
            <div className="text-left">
              <h1 className="text-sm font-bold text-green-600 group-hover:text-green-800 transition-all duration-200 leading-tight">Parampara Eats</h1>
              <p className="text-xs text-gray-500 leading-tight">Organic & Fresh</p>
            </div>
          </button>

          {/* Right: Profile, My Orders/Dashboard & Cart */}
          <div className="flex items-center space-x-1">
            {/* My Orders button for normal users, Dashboard for admin */}
            {user && (
              <Button
                variant="ghost"
                size="icon"
                ...
                className="hover:bg-gray-100 transition-colors duration-200 rounded-lg h-10 w-10"
                title={user.role === 'Admin' ? 'Dashboard' : 'My Orders'}
              >
                {user.role === 'Admin' ? (
        ...
        <div className="hidden lg:flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            ...
            >
              ...
              />
              <div className="text-left">
                <h1 className="text-xl font-bold text-green-600 group-hover:text-green-800 transition-all duration-200 leading-tight">Parampara Eats</h1>
