...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className={`product-card bg-white rounded-3xl shadow-sm border border-gray-100 group ${animationClass} ${hoverEffectClass} flex flex-col h-full transform hover:rotate-1 hover:scale-105 transition-all duration-300`}
         style={{ 
